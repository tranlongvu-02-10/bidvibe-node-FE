...
export const HomePage = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero — luôn hiện, không phụ thuộc vào API */}
      <section className="max-w-7xl mx-auto px-4 pt-16 pb-12 text-center">
        ...
        <div className="flex items-center justify-center gap-3">
          <Link to="/sessions" className="px-6 py-3 bg-purple-600 text-white rounded-xl text-sm font-medium hover:bg-purple-700 transition-colors">
            Khám phá phiên đấu giá
          </Link>
          <Link to="/items/submit" className="px-6 py-3 border border-gray-200 dark:border-gray-700 rounded-xl text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
            Ký gửi vật phẩm
          </Link>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 py-12">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link to="/sessions?status=ACTIVE" className="flex items-center gap-1 text-sm text-purple-600 hover:text-purple-700">
        ...
        {loadingLive ? (
          ...
          <div className="text-center py-12 text-gray-400 text-sm bg-gray-50 dark:bg-gray-900/50 rounded-2xl">
      ...
      <section className="max-w-7xl mx-auto px-4 pb-12">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link to="/sessions?status=SCHEDULED" className="flex items-center gap-1 text-sm text-purple-600 hover:text-purple-700">
            Xem tất cả <ArrowRight size={14} />
          </Link>
        </div>
            ...
            {[
              {
                ...
                desc:  'Tăng dần, Giảm dần và Đấu giá kín — mỗi hình thức mang trải nghiệm khác nhau.',
              },
              {
              ...
              <div key={f.title} className="text-center">
                ...
                <h3 className="text-sm font-medium text-gray-900 dark:text-white mb-2">{f.title}</h3>
